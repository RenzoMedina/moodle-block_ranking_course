...
/**
 * Form for editing ranking_course block instances.
 *
 * @package     block_ranking_course
 * @copyright   2026 Renzo Medina <medinast30@gmail.com>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_ranking_course_edit_form extends block_edit_form {

    /**
     * Extends the configuration form for block_ranking_course.
     *
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('select', 'config_activeusers', get_string('activeusers', 'block_ranking_course'), [
            1 => get_string('nameusers', 'block_ranking_course'),
            0 => get_string('hiddenusers', 'block_ranking_course'),
        ]);
